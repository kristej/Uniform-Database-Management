...
$con=mysqli_connect($host,$user,$password,$db);
  ...
  if(isset($_POST['submit']))
  {
    ...
    $gender=$_POST['Gender'];
    $shirtcolour=$_POST['Shirt'];
    $shirtsize=$_POST['Shirt_Size'];
    $shirtquantity=$_POST['Shirt_Quantity'];
    $pantcolour=$_POST['Pant'];
    $pantsize=$_POST['Pant_Size'];
    $pantquantity=$_POST['Pant_Quantity'];
    $badgecolour=$_POST['Badge'];
    $badgequantity=$_POST['Badge_Quantity'];
    $shoecolour=$_POST['Shoe'];
    $shoesize=$_POST['Shoe_Size'];
    $shoequantity=$_POST['Shoe_Quantity'];

    echo $studentid;

    $sql="INSERT INTO studentdetails (studentid,name,mobile,gender) VALUES ('$studentid','$name','$mobile','$gender')";
    $sq2="INSERT INTO shirt (studentid,shirtcolour,shirtsize,shirtquantity) VALUES ('$studentid','$shirtcolour','$shirtsize','$shirtquantity')";
    $sq3="INSERT INTO pant (studentid,pantcolour,pantsize,pantquantity) VALUES ('$studentid','$pantcolour','$pantsize','$pantquantity')";
    $sq4="INSERT INTO badge (studentid,badgecolour,badgequantity) VALUES ('$studentid','$badgecolour','$badgequantity')";
    $sq5="INSERT INTO shoes (studentid,shoecolour,shoequantity) VALUES ('$studentid','$shoecolour','$shoequantity')";

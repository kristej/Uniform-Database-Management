...
{   
   ...
   $message=$_GET['message'];
    ...
    if($data)
    {
     ...
     echo "<script> alert('Thank you for the feedback!'); window.location.assign('Landing.php'); </script>"; 
        exit();
    }
    else
    {
...
<footer class="footer-distributed">
			...
			<div class="footer-right">
				...
				<form action="#" method="GET">
					...
					<textarea name="message" style="color: black" placeholder="Message"></textarea>
